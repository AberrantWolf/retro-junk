...
// A single flat lookup table; splitting it would only obscure the code-to-name mapping.
#[allow(clippy::too_many_lines)]
pub(crate) fn old_licensee_name(code: u8) -> Option<&'static str> {
    match code {
        0x00 => Some("None"),
        0x01 | 0x31 => Some("Nintendo"),
        0x08 | 0x38 => Some("Capcom"),
        0x09 => Some("Hot-B"), // GB only
        0x0A | 0xE0 => Some("Jaleco"),
        0x0B => Some("Coconuts Japan"),
        0x0C | 0x6E => Some("Elite Systems"),        // GB only
        0x13 | 0x69 => Some("EA (Electronic Arts)"), // GB only
        ...
        0x1F | 0x4A | 0x61 => Some("Virgin Interactive"), // GB only
        ...
        0xB9 | 0xCE => Some("Pony Canyon"), // GB only
        0xBA => Some("Culture Brain"),
        0xBB => Some("Sunsoft"),
        0xBD => Some("Sony Imagesoft"),
        0xBF => Some("Sammy"),
        0xC0 | 0xD0 => Some("Taito"),
        0xC3 => Some("Square"),
        0xC5 => Some("Data East"),

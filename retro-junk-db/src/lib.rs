...
pub use library::{
    ...
    ArchivedPlayableRepresentation, ConsoleScanToken, EntryAnalysisCommand, EntryAnalysisUpdate,
    ...
    create_modded_and_tag_entry, delete_library_console_if_empty, delete_library_root,

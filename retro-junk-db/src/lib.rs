...
pub use library::{
    ...
    ScannedLibraryEntry, SortDirection, SourceFileDescriptor, SourceFileKind, apply_entry_analysis,
    ...
    create_modded_and_tag_entry, delete_library_root, ensure_library_console, file_source_key,
    get_library_root_id, list_console_summaries, load_consoles_for_root, load_entries_for_console,
    load_entry_detail, load_entry_details, load_entry_details_for_console,
    load_export_entries_for_console, mark_console_stale, normalize_relative_path, query_entry_list,

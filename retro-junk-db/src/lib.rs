...
pub use library::{
    ...
    ConsoleScanToken, EntryAnalysisCommand, EntryAnalysisUpdate, EntryHashUpdate,
    LibraryAvailabilityCounts, LibraryChangeSet, LibraryConsoleDescriptor, LibraryConsoleId,
    ...
    LibraryEntryListQuery, LibraryEntryRow, LibraryEntrySortField, LibraryError,
    LibraryExportEntry, LibraryRootId, LibraryScanState, LibrarySourceKey, ScannedLibraryEntry,

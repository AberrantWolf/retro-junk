...
fn collection_entry_lifecycle() {
    ...
    let entry = CollectionEntry {
        ...
        rom_path: "/roms/nes/Super Mario Bros. (USA).nes".to_string(),
        verified_at: "2024-01-15T00:00:00Z".to_string(),
    };
...
fn collection_counts_by_platform_works() {
    ...
    let m2 = Media {
        ...
        rom_name: "Final Fantasy VII (USA) (Disc 1).bin".to_string(),
...
fn collection_upsert_is_idempotent() {
    ...
    let entry = CollectionEntry {
        ...
        notes: String::new(),
        date_acquired: String::new(),
        rom_path: "/roms/nes/smb.nes".to_string(),
        verified_at: String::new(),
    };
